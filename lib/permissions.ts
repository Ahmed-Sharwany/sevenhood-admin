...
export const ALL_PERMISSIONS: PermissionDef[] = [
  ...
  { id: 'send_push_notifications', label: 'Push Notifications',  desc: 'Send push notifications to residents',   icon: '🔔', group: 'Engagement'  },
...
export const ROLE_DEFAULT_PERMISSIONS: Record<string, string[]> = {
  ...
  operator:         ['invite_residents', 'manage_bookings', 'manage_tickets', 'manage_visitors', 'send_push_notifications'],
...
export const HREF_PERMISSION: Record<string, string> = {
  ...
  '/notifications':  'send_push_notifications',
